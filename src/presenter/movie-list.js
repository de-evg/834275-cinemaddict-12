...
class FilmList {
  ...
  _renderMainFilmList() {
    ...
    const filmsContainer = this._mainMovieListComponent.getElement().querySelector(`.films-list__container`);
    this._renderFilms(filmsContainer, films.slice(0, Math.min(filmsCount, this._renderedFilmCount)));
