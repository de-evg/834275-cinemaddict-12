...
class FilmList {
  ...
  _renderMainFilmList() {
    ...
    const prevMainMovieListComponent = this._mainMovieListComponent;
    ...
    if (prevMainMovieListComponent) {
      replace(this._mainMovieListComponent, prevMainMovieListComponent);
